module.exports = {
  ...
  UpgradeDescriptions: {
    exoticPermit: [
      "Exotic Animals",
      "Allows the farmer to handle exotic animals",
    ],
    deluxePermit: ["Deluxe Crops", "Allows the farmer to plant luxury crops"],
    barnCollectTimeUpgrade: [
      "Barn Rate",
      "Increases barn animal production speed",
    ],
    ...
    coopCollectTimeUpgrade: [
      "Coop Rate",
      "Increases Coop animal production speed",
    ],
    ...
    plantGrowthTimeUpgrade: [
      "Crop Growth Time",
      "Decreases total crop growth time",
    ],
    ...
    plantNumHarvestsUpgrade: [
      "Crop Harvests",
      "Increases total harvests for multi harvest crops",
    ],
  },
  // default
  GrowthTimes0: {
