...
function Order({
  ...
  let progressStyle = {
    ...
    boxShadow:
      "0 0 0 1px var(--black), 0 0 0 2px var(--border_yellow), 0 0 0 3px var(--border_shadow_yellow), 0 0 0 4px var(--black)",
  ...
  let completeStyle = {
    ...
    height: progressHeight,
    boxShadow:
      "0 0 0 2px var(--black), 0 0 0 4px var(--border_orange), 0 0 0 6px var(--border_shadow_orange), 0 0 0 8px var(--black)",
    backgroundColor: "var(--menu_lighter)",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p style={{ textDecoration: "underline", fontSize: "2.2vh" }}>
            REWARD
          </p>
          ...
          {rewardInfo[1] !== -1 && (
            ...
            >
              <img
                src={`${process.env.PUBLIC_URL}/assets/images/${rewardInfo[0]}.png`}
                style={{ width: "20%" }}
              />
              x {rewardInfo[1]}
            </div>
      ...
      >
        ...
        >
          ...
          {CONSTANTS.InventoryDescriptions[good][0]}
          <div
            style={{
              position: "absolute",
              right: "-32%",
