            ...
            return (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ width: '100%', }}><CompLeaderboardSlot key={"Balance"} item={"Balance"} data={leadersAll.Balance} /></div>
                        <div style={{ width: '100%' }}><CompLeaderboardSlot key={"XP"} item={"XP"} data={leadersAll.XP} /></div>
