            ...
            <div
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', padding: '0 3% 2% 3%' }}>
                            {hearts.map((num) => {
                                if (num === 1) {
                                    return (
                                        <img
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                                {
                                    ANIMALINFO.foodPreferences?.[type].like.map((name) => {
                                        return (<img
                                            ...
                                            style={{
                                                width: `${100 / ANIMALINFO.foodPreferences?.[type].like.length > 50 ? 50 : 100 / ANIMALINFO.foodPreferences?.[type].like.length}%`,
                                            }}
                                        />)
                                    })
                                }
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                                {
                                    ANIMALINFO.foodPreferences?.[type].dislike.map((name) => {
                                        return (<img
                                            src={`${process.env.PUBLIC_URL}/assets/images/${name}.png`}
                                            style={{
                                                width: `${100 / ANIMALINFO.foodPreferences?.[type].dislike.length > 50 ? 50 : 100 / ANIMALINFO.foodPreferences?.[type].dislike.length}%`,
                                            }}
                                        />)
                                    })
                                }
