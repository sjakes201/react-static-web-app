      ...
      >
        ...
        >
          ...
          >
            ...
            <hr
              style={{ width: "50%", border: "1px solid var(--menu_dark)" }}
            />
          ...
          >
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/goat_standing_right.png`}
              style={{ width: "9%", objectFit: "contain" }}
            />
            <input type="submit" value="Reset Password" />
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/ostrich_standing_right.png`}
              style={{ width: "9%", objectFit: "contain" }}
            />
          </div>
        </form>
